		...
		methods: {
			...
			initItems() {
				let items = [
						...
						[{title: "会员管理", icon: "images/calendar.png", name: 'StaticsManager', level: 2}, {title: "修改资料", icon: "images/info.png", level: 1, name: 'ModifyProfile' }, {title: "我的账号", icon: "images/user.png", level: 1}]
					];
